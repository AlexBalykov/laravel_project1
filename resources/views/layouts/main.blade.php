  ...
  <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
	...
	<footer class="text-gray-600 body-font">
		<div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
			...
			<p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">Copyright © 2020 All Rights Reserved
			</p>
			<p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
				<a class="<?php if(session('locale') == 'en'){echo 'text-indigo-500';} ?> inline-flex items-center ml-4" href="{{ route('locale', 'en') }}">En</a>
				<a class="<?php if(session('locale') == 'ru'){echo 'text-indigo-500';} ?> inline-flex items-center ml-4" href="{{ route('locale', 'ru') }}">Ru</a>
			</p>
